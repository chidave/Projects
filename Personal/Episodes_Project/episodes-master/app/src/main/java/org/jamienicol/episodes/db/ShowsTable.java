...
public class ShowsTable
{
	...
	public static final String COLUMN_TYPE_RATING = "INTEGER";
	public static final String COLUMN_TYPE_COMMENT = "STRING";
	public static final String COLUMN_TYPE_GENRE = "TEXT";
	public static final String COLUMN_TYPE_STATUS = "TEXT";
	public static final String COLUMN_TYPE_CAST = "TEXT";
	public static final String COLUMN_TYPE_RUNTIME = "TEXT";
	public static final String COLUMN_TYPE_IMDB = "TEXT";
	...
	public static final String COLUMN_TYPE_CONTENT_RATING = "TEXT";
	public static final String COLUMN_TYPE_LAST_VIEWED = "TEXT";
	...
	public static void onCreate(SQLiteDatabase db) {
		String create =
			String.format("CREATE TABLE %s ("  +
					      ...
					      COLUMN_CONTENT_RATING, COLUMN_TYPE_CONTENT_RATING,
						  COLUMN_COMMENT, COLUMN_TYPE_COMMENT,
					      COLUMN_GENRE, COLUMN_TYPE_GENRE,
					      COLUMN_STATUS, COLUMN_TYPE_STATUS,
					      COLUMN_CAST, COLUMN_TYPE_CAST,
					 	  COLUMN_RUNTIME, COLUMN_TYPE_RUNTIME,
						  COLUMN_IMDB, COLUMN_TYPE_IMDB,
						  ...
						  COLUMN_RATING, COLUMN_TYPE_RATING,
						  COLUMN_LAST_VIEWED, COLUMN_TYPE_LAST_VIEWED);
