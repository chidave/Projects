...
//This class was used to place an image in the list of search results
	...
	implements LoaderManager.LoaderCallbacks<List<Show>>
{
	public static AddShowSearchFragment newInstance(String query) {
		...
		//query is the title the user searched
		...
		extends ArrayAdapter<Show>
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (bannerPath != null && !bannerPath.equals("")) {
				...
				Log.i("AddShowSearchFragment", "No banner associated with show: " + getItem(position).getName());
			}
