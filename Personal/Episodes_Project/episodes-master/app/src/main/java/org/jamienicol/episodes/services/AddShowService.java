...
public class AddShowService extends IntentService
{
	...
	private int insertShow(Show show) {
		...
		showValues.put(ShowsTable.COLUMN_GENRE, show.getGenre());
		showValues.put(ShowsTable.COLUMN_STATUS, show.getStatus());
		showValues.put(ShowsTable.COLUMN_CONTENT_RATING, show.getContentRating());
		showValues.put(ShowsTable.COLUMN_CAST, show.getCast());
		showValues.put(ShowsTable.COLUMN_RUNTIME, show.getRuntime());
		showValues.put(ShowsTable.COLUMN_IMDB, show.getImdb());
		...
		showValues.put(ShowsTable.COLUMN_COMMENT, " ");
		showValues.put(ShowsTable.COLUMN_RATING, show.getRating());
		showValues.put(ShowsTable.COLUMN_LAST_VIEWED, show.getLastViewed());
